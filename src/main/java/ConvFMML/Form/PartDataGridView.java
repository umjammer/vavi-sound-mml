...
package ConvFMML.Form;
    ...
    public partial class PartDataGridView extends UserControl
    {
        ...
        {
            var rows = new ArrayList<DataGridViewRow>();
        ...
        private void AutoModifyPart()
        {
            ...
            for (DataGridViewRow row : dgv.Rows)
            {
        ...
        private void dgv_CellEnter(Object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (column instanceof DataGridViewTextBoxColumn && column == PartNameColumn)
            {
                SendKeys.SendWait("{F2}");
            }
            else if (column instanceof DataGridViewComboBoxColumn && column == SoundModuleColumn)
            {
